...
def main():
    if len(sys.argv)==2:
        ...
        print("Usage: python3 gen_pcordic.py <B>")
        return
    ...
    for i in range(0,N+1):
        print("signal x%d : signed(0 to B-1);"%(i)) 
        print("signal y%d : signed(0 to B-1);"%(i))
    
    print("begin")
    for i in range(0,N):
        print(instantiation.format(i,"B",sigma[i],i,i+1,RR[i]))
